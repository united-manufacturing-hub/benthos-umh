...
type TimeSeriesPayload struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	ScalarType ScalarType             `protobuf:"varint,1,opt,name=scalar_type,json=scalarType,proto3,enum=proto.ScalarType" json:"scalar_type,omitempty"` // numeric / string / boolean (for frontend convenience)
...
type EventTableEntry struct {
	...
	PayloadFormat PayloadFormat          `protobuf:"varint,2,opt,name=payload_format,json=payloadFormat,proto3,enum=proto.PayloadFormat" json:"payload_format,omitempty"` // TIMESERIES/RELATIONAL (frontend convenience)
...
const file_topic_browser_data_proto_rawDesc = "" +
	"\n" +
	"\x18topic_browser_data.proto\x12\x05proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xbd\x02\n" +
	"\tTopicInfo\x12\x16\n" +
	...
	"\bmetadata\x18\x06 \x03(\v2\x1e.proto.TopicInfo.MetadataEntryR\bmetadata\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0f\n" +
	"\r_virtual_path\"\x90\x01\n" +
	"\bTopicMap\x126\n" +
	"\aentries\x18\x01 \x03(\v2\x1c.proto.TopicMap.EntriesEntryR\aentries\x1aL\n" +
	"\fEntriesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12&\n" +
	"\x05value\x18\x02 \x01(\v2\x10.proto.TopicInfoR\x05value:\x028\x01\"\x9c\x01\n" +
	"\n" +
	"EventKafka\x128\n" +
	"\aheaders\x18\x01 \x03(\v2\x1e.proto.EventKafka.HeadersEntryR\aheaders\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayload\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xbe\x02\n" +
	"\x11TimeSeriesPayload\x122\n" +
	"\vscalar_type\x18\x01 \x01(\x0e2\x11.proto.ScalarTypeR\n" +
	"scalarType\x12C\n" +
	...
	"\x04json\x18\x01 \x01(\fR\x04json\"\xcf\x02\n" +
	"\x0fEventTableEntry\x12\x1e\n" +
	"\vuns_tree_id\x18\x01 \x01(\tR\tunsTreeId\x12;\n" +
	"\x0epayload_format\x18\x02 \x01(\x0e2\x14.proto.PayloadFormatR\rpayloadFormat\x125\n" +
	"\rraw_kafka_msg\x18\x05 \x01(\v2\x11.proto.EventKafkaR\vrawKafkaMsg\x12\x1d\n" +
	"\n" +
	"bridged_by\x18\x06 \x03(\tR\tbridgedBy\x12$\n" +
	"\x0eproduced_at_ms\x18\a \x01(\x04R\fproducedAtMs\x12*\n" +
	"\x02ts\x18\n" +
	" \x01(\v2\x18.proto.TimeSeriesPayloadH\x00R\x02ts\x12,\n" +
	"\x03rel\x18\v \x01(\v2\x18.proto.RelationalPayloadH\x00R\x03relB\t\n" +
	"\apayload\">\n" +
	"\n" +
	"EventTable\x120\n" +
	"\aentries\x18\x01 \x03(\v2\x16.proto.EventTableEntryR\aentries\"`\n" +
	"\tUnsBundle\x12(\n" +
	"\auns_map\x18\x01 \x01(\v2\x0f.proto.TopicMapR\x06unsMap\x12)\n" +
	"\x06events\x18\x02 \x01(\v2\x11.proto.EventTableR\x06events*O\n" +
...
var file_topic_browser_data_proto_goTypes = []any{
	(PayloadFormat)(0),             // 0: proto.PayloadFormat
	(ScalarType)(0),                // 1: proto.ScalarType
	(*TopicInfo)(nil),              // 2: proto.TopicInfo
	(*TopicMap)(nil),               // 3: proto.TopicMap
	(*EventKafka)(nil),             // 4: proto.EventKafka
	(*TimeSeriesPayload)(nil),      // 5: proto.TimeSeriesPayload
	(*RelationalPayload)(nil),      // 6: proto.RelationalPayload
	(*EventTableEntry)(nil),        // 7: proto.EventTableEntry
	(*EventTable)(nil),             // 8: proto.EventTable
	(*UnsBundle)(nil),              // 9: proto.UnsBundle
	nil,                            // 10: proto.TopicInfo.MetadataEntry
	nil,                            // 11: proto.TopicMap.EntriesEntry
	nil,                            // 12: proto.EventKafka.HeadersEntry
...
var file_topic_browser_data_proto_depIdxs = []int32{
	10, // 0: proto.TopicInfo.metadata:type_name -> proto.TopicInfo.MetadataEntry
	11, // 1: proto.TopicMap.entries:type_name -> proto.TopicMap.EntriesEntry
	12, // 2: proto.EventKafka.headers:type_name -> proto.EventKafka.HeadersEntry
	1,  // 3: proto.TimeSeriesPayload.scalar_type:type_name -> proto.ScalarType
	13, // 4: proto.TimeSeriesPayload.numeric_value:type_name -> google.protobuf.DoubleValue
	14, // 5: proto.TimeSeriesPayload.string_value:type_name -> google.protobuf.StringValue
	15, // 6: proto.TimeSeriesPayload.boolean_value:type_name -> google.protobuf.BoolValue
	0,  // 7: proto.EventTableEntry.payload_format:type_name -> proto.PayloadFormat
	4,  // 8: proto.EventTableEntry.raw_kafka_msg:type_name -> proto.EventKafka
	5,  // 9: proto.EventTableEntry.ts:type_name -> proto.TimeSeriesPayload
	6,  // 10: proto.EventTableEntry.rel:type_name -> proto.RelationalPayload
	7,  // 11: proto.EventTable.entries:type_name -> proto.EventTableEntry
	3,  // 12: proto.UnsBundle.uns_map:type_name -> proto.TopicMap
	8,  // 13: proto.UnsBundle.events:type_name -> proto.EventTable
	2,  // 14: proto.TopicMap.EntriesEntry.value:type_name -> proto.TopicInfo
