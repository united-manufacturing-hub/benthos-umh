...
func NewServiceInBaseDir(
	...
	return NewS6Instance(id, servicePath, config, callbacks)
}
...
func NewS6InstanceWithService(
	...
	instance := NewS6Instance(id, servicePath, config, callbacks)
	instance.service = service
	return instance
}

func (s *S6Instance) Remove(ctx context.Context) error {
	return s.sendEvent(ctx, utils.LifecycleEventRemove)
}
