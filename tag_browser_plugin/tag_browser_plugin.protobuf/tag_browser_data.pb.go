...
type EventTableEntry struct {
	...
	Value         string                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`                                    // This is the json payload of our event
...
func (x *EventTableEntry) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
const file_tag_browser_data_proto_rawDesc = "" +
	...
	"umh.events\x1a\x1egoogle/protobuf/wrappers.proto\"\xc7\x03\n" +
	"\aUnsInfo\x12\x1e\n" +
	"\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.umh.events.UnsInfoR\x05value:\x028\x01\"\xb6\x01\n" +
	"\n" +
	"EventKafka\x12=\n" +
	"\aheaders\x18\x01 \x03(\v2#.umh.events.EventKafka.HeadersEntryR\aheaders\x12-\n" +
	"\x12inserted_timestamp\x18\x02 \x01(\x03R\x11insertedTimestamp\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x82\x02\n" +
	"\x0fEventTableEntry\x12\x1e\n" +
	"\vuns_tree_id\x18\x01 \x01(\tR\tunsTreeId\x12\x14\n" +
...
var file_tag_browser_data_proto_depIdxs = []int32{
	...
	2,  // 9: umh.events.EventTableEntry.raw_kafka_msg:type_name -> umh.events.EventKafka
	3,  // 10: umh.events.EventTable.entries:type_name -> umh.events.EventTableEntry
	1,  // 11: umh.events.UnsBundle.uns_map:type_name -> umh.events.UnsMap
	4,  // 12: umh.events.UnsBundle.events:type_name -> umh.events.EventTable
	0,  // 13: umh.events.UnsMap.EntriesEntry.value:type_name -> umh.events.UnsInfo
