...
- **[Beckhoff ADS (experimental)](beckhoff-ads/README.md)** - Reads Beckhoff PLCs over ADS with change notifications or interval polling, addressing variables by symbol name. Covers TwinCAT 2 and TwinCAT 3, with automatic route registration.
