...
var _ = Describe("Test against KepServer EX6", func() {
	...
	DescribeTable("Selecting a custom SecurityPolicy", func(input *OPCUAInput) {
		...
		Entry("should connect via Basic256Sha256 SignAndEncrypt", &OPCUAInput{
			...
			// This is a local test certificate, which we trusted on KepServerEx-client
			...
			ServerCertificateFingerprint: "14042a48166099e7d0547edf33ce950bcb6d63e946f847d7d83ae3b42fd889a50e7c097d1e4ee9ff38493eb112f5c8e72c0ad87c2d9496d02095720ca0119d47",
		}),
